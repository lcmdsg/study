  ...
  <div class="middlecontent">
    ...
    <div class="family-container">
      ...
      <div class="content-block">
        <div class="content-title">{{momlist.title}}</div>
        <div class="content-desc">{{momlist.desc}}</div>
        <div class="content-goods-wrap">
          <family-card
            v-for="(item, index) in momlist.list"
            :key="index"
            :detail="item"
            :index="index"
          ></family-card>
...
export default {
  ...
  created() {
    let that = this;
    axios.get("../../../data/mother.json").then(function(res) {
      that.momlist = res.data.mom;
    });
  },
  components: {
    swiper,
